...
from agntcy_acp.langgraph.api_bridge import APIBridgeInput, APIBridgeOutput
from pydantic import BaseModel, Field

from marketing_campaign import email_reviewer, mailcomposer
...
class ConfigModel(BaseModel):
    ...
    target_audience: email_reviewer.TargetAudience = Field(
